...
var CanvasSpriteRenderer = class {
  ...
  render(sprite) {
    ...
    if (texture.orig.width <= 0 || texture.orig.height <= 0 || !texture.valid || !source)
      return;
    renderer.canvasContext.setBlendMode(sprite.blendMode, true), context.globalAlpha = sprite.worldAlpha;
...
//# sourceMappingURL=@pixi_canvas-sprite.js.map
