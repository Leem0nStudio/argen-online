import {
  Graphics
} from "./chunk-24WBPAWJ.js";
import {
  CanvasRenderer,
  canvasUtils
} from "./chunk-HJDWIDIC.js";
import "./chunk-RYFJL6YI.js";
import {
  Color,
  ExtensionType,
  Matrix,
...
Graphics.prototype.generateCanvasTexture = function(scaleMode, resolution = 1) {
  ...
  canvasRenderer || (canvasRenderer = new CanvasRenderer()), this.transform.updateLocalTransform(), this.transform.localTransform.copyTo(tempMatrix), tempMatrix.invert(), tempMatrix.tx -= bounds.x, tempMatrix.ty -= bounds.y, canvasRenderer.render(this, { renderTexture: canvasBuffer, clear: true, transform: tempMatrix });
...
Graphics.prototype._renderCanvas = function(renderer) {
  this.isMask !== true && (this.finishPoly(), renderer.plugins.graphics.render(this));
};
...
var PolygonUtils = class _PolygonUtils {
  ...
  static offsetPolygon(points, offset) {
    ...
    for (let j = 0; j < length; j += 2) {
      ...
      const norm2x = -v2y, norm2y = v2x, pjk1 = [points[j] + norm2x, points[j + 1] + norm2y], pjk2 = [points[k] + norm2x, points[k + 1] + norm2y], intersectPoint = _PolygonUtils.findIntersection(pij1[0], pij1[1], pij2[0], pij2[1], pjk1[0], pjk1[1], pjk2[0], pjk2[1]);
  ...
  setPatternTransform(pattern, matrix) {
    if (this._svgMatrix !== false) {
      if (!this._svgMatrix) {
        ...
        if ((svg == null ? void 0 : svg.createSVGMatrix) && (this._svgMatrix = svg.createSVGMatrix()), !this._svgMatrix || !pattern.setTransform) {
...
//# sourceMappingURL=@pixi_canvas-graphics.js.map
